	...
	public static void main(String[] args) throws InterruptedException, IOException {
        ...
        for(int i = 1; i <= sheet.getLastRowNum(); i++) {
          ...
          //  String Permission = (celldata.getCell(3) != null) ? celldata.getCell(3).getStringCellValue() : "";
            String Permission1 = (celldata.getCell(3) != null) ? getCellValueAsString(celldata.getCell(3)) : "";
            ...
            if (Attendanance.equalsIgnoreCase("Present")) {
                ...
                Perm.sendKeys(Permission1);      // Input permission value
