...
public class PrcTc {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (int i = 1; i <= sheet.getLastRowNum(); i++) {
            ...
            String Permission = (celldata.getCell(3) != null) ? celldata.getCell(3).getStringCellValue() : "";
            ...
            WebElement Atten = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[1]/section[2]/div[1]/div[2]/div/div/div[2]/form/div[1]/div/div/div/div[2]/div/div/div[2]/table/tbody/tr/td[6]/select")));
            ...
            try {
                // Wait for and set the shift
                WebElement shift = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[1]/section[2]/div[1]/div[2]/div/div/div[2]/form/div[1]/div/div/div/div[2]/div/div/div[2]/table/tbody/tr/td[7]/select")));
                shift.click();
                shift.sendKeys(Shift);
            } catch (Exception e) {
                System.out.println("Shift element not found or not interactable for row: " + i + ". Exception: " + e.getMessage());
            }

            try {
                // Wait for and set the permission
                WebElement Perm = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div[1]/section[2]/div[1]/div[2]/div/div/div[2]/form/div[1]/div/div/div/div[2]/div/div/div[2]/table/tbody/tr/td[8]/select")));
                Perm.click();
                Perm.sendKeys(Permission);
            } catch (Exception e) {
                System.out.println("Permission element not found or not interactable for row: " + i + ". Exception: " + e.getMessage());
            }
        }
