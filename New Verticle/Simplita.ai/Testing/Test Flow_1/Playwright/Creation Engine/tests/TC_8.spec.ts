...
test.describe('Verify Creation Engine functionality', () => {
    ...
    // Test: Verify Search field Functionality
    test('Verify Search field Functionality', async ({ page }) => {
        try {
            // Locate the Search field
            const searchField = page.locator('input[type="text"][placeholder="Search fields..."]');

             // Click the Searchfield button
