...
test.describe('Verify Creation Engine functionality', () => {
    ...
    test.beforeEach(async ({ page }) => {
        ...
        await chatField.fill("Create the Employee details form with 8 fields only");
    ...
    // Test: Verify Next Button and previous Button Functionalit
    test('Verify Next Button and previous Button Functionality', async ({ page }) => {
        try {
            ...
            const previousButton = page.locator('//button[contains(text(), "Previous")]');
